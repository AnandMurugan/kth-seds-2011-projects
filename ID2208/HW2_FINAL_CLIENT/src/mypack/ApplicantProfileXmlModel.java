...
public class ApplicantProfileXmlModel {
    ...
    public void setEmail(String companyName, String email) {
        NodeList nodes = profileXmlDoc.getElementsByTagName("ns1:company");
        System.out.println("this is the content" + nodes.toString());
        if (nodes.getLength() > 0) // if there are company info nodes
        {
            String currentCompanyName;
            for (int i = 0; i < nodes.getLength(); i++) {
                Node node1 = nodes.item(i).getFirstChild();
                System.out.println("this is the name of node: " + nodes.item(i).getNodeName());
                System.out.println("this is the content of node1: " + node1.getNodeName());
                
                Node node2 = node1.getFirstChild();
                System.out.println("this is the content of node2: " + node2.getNodeName());

                //Node node2 = node1.getFirstChild();
                currentCompanyName = node2.getTextContent();
                if (currentCompanyName.equalsIgnoreCase(companyName)) {
