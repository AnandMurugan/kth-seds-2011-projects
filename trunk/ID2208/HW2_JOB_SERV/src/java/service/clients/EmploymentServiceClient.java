...
public class EmploymentServiceClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            String applicantFilePath = "xml/userProfile.xml";
            ...
            generator.Generate("xml/companies.xml", "xml/employment.xml","xml/resume.xml", "xml/transcript.xml", applicantFilePath, xsltFilePath, resumeFilePath, companyInfoSchemaPath );        
