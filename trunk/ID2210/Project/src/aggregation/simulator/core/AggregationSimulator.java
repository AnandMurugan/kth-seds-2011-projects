...
import aggregation.system.peer.Peer;
import aggregation.system.peer.PeerInit;
...
public final class AggregationSimulator extends ComponentDefinition {
...
//-------------------------------------------------------------------	
    Handler<SimulatorInit> handleInit = new Handler<SimulatorInit>() {
        ...
        public void handle(SimulatorInit init) {
            ...
            aggregationConfiguration = init.getAggregationConfiguration();
...
//                new Address(peer0Address.getIp(), peer0Address.getPort(), peerId);
        ...
        trigger(new PeerInit(peerAddress, num, bootstrapConfiguration, cyclonConfiguration, aggregationConfiguration), peer.getControl());
