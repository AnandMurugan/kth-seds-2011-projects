package aggregation.simulator.core;
...
public final class AggregationSimulationMain extends ComponentDefinition {
...
//-------------------------------------------------------------------	
	public static void main(String[] args) {
		...
		Kompics.createAndStart(AggregationSimulationMain.class, 1);
	}

//-------------------------------------------------------------------	
	public AggregationSimulationMain() throws IOException {
		...
		Component simulator = create(AggregationSimulator.class);
		...
		trigger(new SimulatorInit(bootConfiguration, cyclonConfiguration, null, aggregationConfiguration), simulator.getControl());
