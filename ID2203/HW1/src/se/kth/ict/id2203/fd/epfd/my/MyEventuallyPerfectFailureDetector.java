...
import se.kth.ict.id2203.fd.HeartbeatMessage;
...
public class MyEventuallyPerfectFailureDetector extends ComponentDefinition {
    ...
    public MyEventuallyPerfectFailureDetector() {
    ...
    //handlers
    Handler<MyEventuallyPerfectFailureDetectorInit> initHandler = new Handler<MyEventuallyPerfectFailureDetectorInit>() {
        @Override
        public void handle(MyEventuallyPerfectFailureDetectorInit event) {
            self = event.getSelf();
